...
| Ao iniciar, aparece que a aplicação não respondeu em 60 segundos | A aplicação demorou demais para subir, ou não subiu | Veja `trace.log` — o caminho exato para o seu pacote está no capítulo Onde estão os logs |
