...
![Página de download do Docker Desktop](img/manual/docker-download.png)
...
![Aviso de configuração do instalador do Docker Desktop](img/manual/docker-wizard-01.png)

A instalação leva alguns minutos.

![Instalação em andamento](img/manual/docker-wizard-02.png)

Ao final, o instalador avisa que a instalação terminou e pede para
reiniciar o computador. Reinicie quando ele pedir.

![Instalação concluída, pedindo reinício](img/manual/docker-wizard-03.png)
...
![Docker Desktop aberto com o ícone verde](img/manual/docker-verde.png)
