...
- O arquivo `GoFacialEmulator-windows.zip`.
...
**Nenhuma outra instalação é necessária.** O banco de dados já vem
embutido neste pacote — não precisa instalar nada além do que já está no
ZIP.
